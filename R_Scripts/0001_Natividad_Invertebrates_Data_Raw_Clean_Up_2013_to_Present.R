...
system("ls -lt ~/Desktop/NSF_CHN/Ecology/ReefCheck/Data_Raw/*invertebratesrawupdated* > ~/Desktop/NSF_CHN/Ecology/ReefCheck/Sandbox/Natividad_2013_to_Present_Reef_Check_Invertebratesraw_filelist_latest.txt")
# load the list of files into a table
currentTable = read.table("~/Desktop/NSF_CHN/Ecology/ReefCheck/Sandbox/Natividad_2013_to_Present_Reef_Check_Invertebratesraw_filelist_latest.txt",as.is=TRUE)
...
NatividadInvertebratesRaw$Location <- sapply(NatividadInvertebratesRaw$Location, function(x) gsub("puntaprieta", "PuntaPrieta", x, ignore.case=TRUE))
...
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("abulonamarillo", "Haliotiscorrugata", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("abulonazul", "Haliotisfulgens", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("almejaderoca", "Crassedomagiganteum", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("almejaroca", "Crassedomagiganteum", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("arbolitocafe/dorado", "Muriceasp", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("arbolitosrojo", "Lophogorgiachilensis", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("arbolitos", "Muriceasp", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("caracolundosa", "Megastraeaundosa", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("caracoltornillo", "Kelletiakelletii", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("caracolturbanico", "Megastraeaturbanica", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("erizoespinudo", "Centrostephanuscoronatus", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("erizomorado", "Strongylocentrotuspurpuratus", x, ignore.case=TRUE))
NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("erizorojo", "Mesocentrotusfranciscanus", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("estrellagigante", "Pisastergiganteus", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("langosta", "Panulirusinterruptus", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("lapachina", "Megathuracrenulata", x, ignore.case=TRUE))

NatividadInvertebratesRaw$Genusspecies <- sapply(NatividadInvertebratesRaw$Genusspecies, function(x) gsub("pepino", "Parastichopusparvimensis", x, ignore.case=TRUE))
...
NatividadInvertebrates13to <- NatividadInvertebrates

write.table(NatividadInvertebrates13to, "~/Desktop/NSF_CHN/Ecology/ReefCheck/Data_Clean/Natividad_Invertebrates_clean_data_2013_to_Present.csv", sep=",", col.names=T, row.names=F)
