...
write.table(SASoutput, "/Users/boch1976/Desktop/NSF_CHN/Ecology/ReefCheck/Sandbox/Natividad_Reef_Check_Fishes_data_2006_2014_SASoutput.csv", sep=",", col.names=T, row.names=F)
